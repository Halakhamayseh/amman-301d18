...
function Product(name) {
  this.name = name;
  this.path = this.path = `img/${name}.jpg`;
  this.votes = 0;
  this.views = 0;
...
function displayPics(){
  ...
  // because the var is global declaration(Hoisting) ,but let is local declaration,we can not access rendo outside the while statement
