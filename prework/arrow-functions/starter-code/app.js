...
//consturtor fuction can not be transfered in to arrow fuction//
...
// TODO: After viewing the previous console.log(), return the code to a working state.
// can not be transfered in to arrow fuction because there is this //
...
// 3. Explain why "this" is different when an arrow function is used:because arrow  fun is not access this ,it refer to parnt
